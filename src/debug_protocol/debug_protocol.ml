...
module Response = struct
  ...
  module Message = struct
    ...
    let of_yojson = function
      ...
      | `String "notStopped" -> Ok Not_stopped
      | `String str -> Ok (Custom str)  | _ -> Error (print_exn_at_loc [%here])

    let to_yojson = function
      | Cancelled -> `String "cancelled"
      | Not_stopped -> `String "notStopped"
      | Custom str -> `String str
  end
...
module Variable_presentation_hint = struct
  ...
  module Attributes = struct
    ...
    let of_yojson = function
      ...
      | `String "hasDataBreakpoint" -> Ok Has_data_breakpoint
      | `String str -> Ok (Custom str)  | _ -> Error (print_exn_at_loc [%here])
    ...
    let to_yojson = function
      ...
      | Has_data_breakpoint -> `String "hasDataBreakpoint"
      | Custom str -> `String str
  end
...
module Start_debugging_command = struct
  let type_ = "startDebugging"
...
module Write_memory_command = struct
  let type_ = "writeMemory"
